...
class UNet(nn.Layer):
    ...
    def __init__(self,
        ...
        self.cls = self.conv = nn.Conv2D(in_channels=112,
...
class Encoder(nn.Layer):
    ...
    def __init__(self, in_channels=3):
        ...
        self.double_conv = nn.Sequential(layers.ConvBNReLU(in_channels, 112, 3),
                                         layers.ConvBNReLU(112, 112, 3))
        # down_channels = [[64, 128], [128, 256], [256, 512], [512, 512]]
        base_ch = int(64 * 1.75)  # 112
        down_channels = [[base_ch, 224], [224, 448], [448, 896], [896, 896]]
...
class Decoder(nn.Layer):
    ...
    def __init__(self, align_corners, use_deconv=False):
        ...
        up_channels = [[896, 448], [448, 224], [224, 112], [112, 112]]
